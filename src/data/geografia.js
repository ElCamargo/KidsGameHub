...
/* [nome, capital, bandeira]. A bandeira é opcional: dos 30 estados
   americanos do jogo temos doze, e os outros seguem só com o nome. */
export const BR_ESTADOS = [
  ["Acre", "Rio Branco", "br-ac"],
  ["Alagoas", "Maceió", "br-al"],
  ["Amapá", "Macapá", "br-ap"],
  ["Amazonas", "Manaus", "br-am"],
  ["Bahia", "Salvador", "br-ba"],
  ["Ceará", "Fortaleza", "br-ce"],
  ["Distrito Federal", "Brasília", "br-df"],
  ["Espírito Santo", "Vitória", "br-es"],
  ["Goiás", "Goiânia", "br-go"],
  ["Maranhão", "São Luís", "br-ma"],
  ["Mato Grosso", "Cuiabá", "br-mt"],
  ["Mato Grosso do Sul", "Campo Grande", "br-ms"],
  ["Minas Gerais", "Belo Horizonte", "br-mg"],
  ["Pará", "Belém", "br-pa"],
  ["Paraíba", "João Pessoa", "br-pb"],
  ["Paraná", "Curitiba", "br-pr"],
  ["Pernambuco", "Recife", "br-pe"],
  ["Piauí", "Teresina", "br-pi"],
  ["Rio de Janeiro", "Rio de Janeiro", "br-rj"],
  ["Rio Grande do Norte", "Natal", "br-rn"],
  ["Rio Grande do Sul", "Porto Alegre", "br-rs"],
  ["Rondônia", "Porto Velho", "br-ro"],
  ["Roraima", "Boa Vista", "br-rr"],
  ["Santa Catarina", "Florianópolis", "br-sc"],
  ["São Paulo", "São Paulo", "br-sp"],
  ["Sergipe", "Aracaju", "br-se"],
  ["Tocantins", "Palmas", "br-to"],
];

export const US_ESTADOS = [
  ["California", "Sacramento", "us-ca"],
  ["Texas", "Austin", "us-tx"],
  ["New York", "Albany", "us-ny"],
  ["Florida", "Tallahassee", "us-fl"],
  ["Illinois", "Springfield"],
  ["Ohio", "Columbus", "us-oh"],
  ["Georgia", "Atlanta"],
  ["Michigan", "Lansing"],
  ["Washington", "Olympia"],
  ["Arizona", "Phoenix", "us-az"],
  ["Colorado", "Denver", "us-co"],
  ["Oregon", "Salem"],
  ["Nevada", "Carson City"],
  ["Utah", "Salt Lake City"],
  ["Alaska", "Juneau", "us-ak"],
  ["Hawaii", "Honolulu", "us-hi"],
  ["Louisiana", "Baton Rouge", "us-la"],
  ["Tennessee", "Nashville"],
  ["Kentucky", "Frankfort"],
...
export const CAP_PT = { MX: "Cidade do México", US: "Washington", HT: "Porto Príncipe", TT: "Porto de Espanha", PT: "Lisboa", IT: "Roma", GB: "Londres", BE: "Bruxelas", CH: "Berna", AT: "Viena", GR: "Atenas", SE: "Estocolmo", DK: "Copenhague", PL: "Varsóvia", RU: "Moscou", UA: "Kiev", CZ: "Praga", RO: "Bucareste", RS: "Belgrado", LU: "Luxemburgo", CY: "Nicósia", AD: "Andorra-a-Velha", MC: "Mônaco", ET: "Adis Abeba", DZ: "Argel", CN: "Pequim", JP: "Tóquio", IN: "Nova Délhi", KR: "Seul", VN: "Hanói", ID: "Jacarta", SA: "Riade", IL: "Jerusalém", NP: "Catmandu", IR: "Teerã", IQ: "Bagdá", MN: "Ulan Bator", KH: "Pnom Pene", LB: "Beirute", SY: "Damasco", SG: "Singapura", IS: "Reiquiavique", UY: "Montevidéu", PY: "Assunção", PA: "Cidade do Panamá", GT: "Cidade da Guatemala" };

/* Francês, alemão e italiano. Mesma regra: só o que muda de grafia — o
   resto usa a forma canônica de CAPITAIS. */
export const CAP_FR = { MX: "Mexico", US: "Washington", TT: "Port-d'Espagne", CU: "La Havane", DO: "Saint-Domingue", GD: "Saint-Georges", PT: "Lisbonne", GB: "Londres", BE: "Bruxelles", CH: "Berne", AT: "Vienne", GR: "Athènes", DK: "Copenhague", PL: "Varsovie", RU: "Moscou", UA: "Kiev", RO: "Bucarest", CY: "Nicosie", AD: "Andorre-la-Vieille", MT: "La Valette", SM: "Saint-Marin", IS: "Reykjavik", EG: "Le Caire", ET: "Addis-Abeba", DZ: "Alger", MU: "Port-Louis", CN: "Pékin", KR: "Séoul", VN: "Hanoï", SA: "Riyad", IL: "Jérusalem", NP: "Katmandou", IR: "Téhéran", IQ: "Bagdad", MN: "Oulan-Bator", LB: "Beyrouth", SY: "Damas", SG: "Singapour", UZ: "Tachkent", BD: "Dacca", AF: "Kaboul", AE: "Abou Dabi", PY: "Assomption", CO: "Bogota", BR: "Brasilia", VU: "Port-Vila" };

export const CAP_DE = { MX: "Mexiko-Stadt", US: "Washington", CU: "Havanna", PT: "Lissabon", IT: "Rom", BE: "Brüssel", AT: "Wien", GR: "Athen", DK: "Kopenhagen", PL: "Warschau", RU: "Moskau", UA: "Kiew", CZ: "Prag", RO: "Bukarest", RS: "Belgrad", CY: "Nikosia", LU: "Luxemburg", EG: "Kairo", ET: "Addis Abeba", DZ: "Algier", CN: "Peking", JP: "Tokio", SA: "Riad", IR: "Teheran", IQ: "Bagdad", SY: "Damaskus", SG: "Singapur", UZ: "Taschkent", GT: "Guatemala-Stadt", PA: "Panama-Stadt" };

export const CAP_IT = { MX: "Città del Messico", US: "Washington", CU: "L'Avana", PT: "Lisbona", GB: "Londra", BE: "Bruxelles", CH: "Berna", GR: "Atene", SE: "Stoccolma", DK: "Copenaghen", PL: "Varsavia", RU: "Mosca", UA: "Kiev", CZ: "Praga", RO: "Bucarest", RS: "Belgrado", HR: "Zagabria", SI: "Lubiana", LU: "Lussemburgo", MT: "La Valletta", IE: "Dublino", EG: "Il Cairo", ET: "Addis Abeba", DZ: "Algeri", TN: "Tunisi", CN: "Pechino", KR: "Seul", ID: "Giacarta", SA: "Riad", IL: "Gerusalemme", IR: "Teheran", MN: "Ulan Bator", SY: "Damasco", BD: "Dacca", GT: "Città del Guatemala", PA: "Città di Panamá", CO: "Bogotà", BR: "Brasilia" };

export const CAP_ES = { CU: "La Habana", US: "Washington", MX: "Ciudad de México", HT: "Puerto Príncipe", TT: "Puerto España", PT: "Lisboa", IT: "Roma", GB: "Londres", BE: "Bruselas", CH: "Berna", AT: "Viena", GR: "Atenas", SE: "Estocolmo", DK: "Copenhague", PL: "Varsovia", RU: "Moscú", UA: "Kiev", CZ: "Praga", RO: "Bucarest", RS: "Belgrado", LU: "Luxemburgo", AD: "Andorra la Vieja", MC: "Mónaco", EG: "El Cairo", ET: "Adís Abeba", DZ: "Argel", CN: "Pekín", JP: "Tokio", IN: "Nueva Delhi", KR: "Seúl", VN: "Hanói", ID: "Yakarta", SA: "Riad", IL: "Jerusalén", NP: "Katmandú", IR: "Teherán", IQ: "Bagdad", MN: "Ulán Bator", KH: "Nom Pen", SY: "Damasco", SG: "Singapur", IS: "Reikiavik", PA: "Ciudad de Panamá", GT: "Ciudad de Guatemala" };
