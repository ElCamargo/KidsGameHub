...
export const T = {
  pt: {
    ...
    askRegiao: "Em que região fica {p}?", whyRegiao: "{p} fica na região {r}.",
  ...
  en: {
    ...
    askRegiao: "Which region is {p} in?", whyRegiao: "{p} is in the {r} region.",
  ...
  es: {
    ...
    askRegiao: "¿En qué región está {p}?", whyRegiao: "{p} está en la región {r}.",
...
export const PACKS = {
  fr: {
    ...
    askRegiao: "Dans quelle région se trouve {p} ?", whyRegiao: "{p} est dans la région {r}.",
  ...
  de: {
    ...
    askRegiao: "In welcher Region liegt {p}?", whyRegiao: "{p} liegt in der Region {r}.",
  ...
  it: {
    ...
    askRegiao: "In quale regione si trova {p}?", whyRegiao: "{p} si trova nella regione {r}.",
