...
export const T = {
  pt: {
    ...
    restoreErr: { formato: "Não consegui ler esse arquivo.", outro: "Esse arquivo não é uma cópia do Clarim.", versao: "Essa cópia é de uma versão mais nova do Clarim.", vazio: "Essa cópia está vazia." },
    voiceOpens: "O Clarim lê as perguntas para você. Alguns jogos abriram!",
    voice: "Voz do Clarim", voiceOn: "Ligada", voiceOff: "Desligada",
    ...
    momentInvite: "Um versículo curto por dia, uma pergunta para conversar e uma pequena atitude — para fazer junto com as crianças, em poucos minutos. Sua família quer isso no Clarim?",
    ...
    giftHint: "170 lumicoins por semana para dar a quem você quiser. O que sobra não acumula.",
    weekTried: "rodadas terminadas sem estrela. Jogou até o fim mesmo assim.",
    ...
    installTitle: "Deixe o Clarim na tela inicial",
  ...
  en: {
    ...
    restoreErr: { formato: "I couldn't read that file.", outro: "That file is not a Clarim copy.", versao: "That copy comes from a newer Clarim.", vazio: "That copy is empty." },
    voiceOpens: "Clarim reads the questions for you. Some games just opened!",
    voice: "Clarim voice", voiceOn: "On", voiceOff: "Off",
    ...
    momentInvite: "A short verse each day, a question to talk about and one small action — to do together with the children, in a few minutes. Would your family like this in Clarim?",
    ...
    giftHint: "170 lumicoins a week to give to whoever you like. What is left does not carry over.",
    weekTried: "rounds finished without a star. Played to the end anyway.",
    ...
    installTitle: "Keep Clarim on your home screen",
  ...
  es: {
    ...
    restoreErr: { formato: "No pude leer ese archivo.", outro: "Ese archivo no es una copia de Clarim.", versao: "Esa copia es de una versión más nueva de Clarim.", vazio: "Esa copia está vacía." },
    voiceOpens: "Clarim te lee las preguntas. ¡Se abrieron algunos juegos!",
    voice: "Voz de Clarim", voiceOn: "Activada", voiceOff: "Apagada",
    ...
    momentInvite: "Un versículo corto cada día, una pregunta para conversar y una pequeña acción — para hacer junto con los niños, en pocos minutos. ¿Su familia quiere esto en Clarim?",
    ...
    giftHint: "170 lumicoins por semana para dar a quien quieras. Lo que sobra no se acumula.",
    weekTried: "rondas terminadas sin estrella. Llegó hasta el final igual.",
    ...
    installTitle: "Deja Clarim en tu pantalla de inicio",
...
export const PACKS = {
  fr: {
    ...
    restoreErr: { formato: "Je n'ai pas pu lire ce fichier.", outro: "Ce fichier n'est pas une copie de Clarim.", versao: "Cette copie vient d'un Clarim plus récent.", vazio: "Cette copie est vide." },
    voiceOpens: "Clarim te lit les questions. Des jeux se sont ouverts !",
    voice: "Voix de Clarim", voiceOn: "Activée", voiceOff: "Désactivée",
    ...
    momentInvite: "Un verset court chaque jour, une question pour discuter et un petit geste — à faire avec les enfants, en quelques minutes. Votre famille souhaite-t-elle cela dans Clarim ?",
    ...
    giftHint: "170 lumicoins par semaine à offrir à qui tu veux. Le reste ne se cumule pas.",
    weekTried: "manches terminées sans étoile. Est allé au bout quand même.",
    ...
    installTitle: "Garde Clarim sur ton écran d'accueil",
  ...
  de: {
    ...
    restoreErr: { formato: "Diese Datei konnte ich nicht lesen.", outro: "Diese Datei ist keine Clarim-Kopie.", versao: "Diese Kopie stammt aus einem neueren Clarim.", vazio: "Diese Kopie ist leer." },
    voiceOpens: "Clarim liest dir die Fragen vor. Ein paar Spiele sind offen!",
    voice: "Clarim-Stimme", voiceOn: "An", voiceOff: "Aus",
    ...
    momentInvite: "Jeden Tag ein kurzer Vers, eine Frage zum Reden und eine kleine Tat — zusammen mit den Kindern, in wenigen Minuten. Möchte eure Familie das in Clarim?",
    ...
    giftHint: "170 Lumicoins pro Woche zum Verschenken. Was übrig bleibt, verfällt.",
    weekTried: "Runden ohne Stern beendet. Trotzdem bis zum Ende gespielt.",
    ...
    installTitle: "Clarim auf den Startbildschirm legen",
  ...
  it: {
    ...
    restoreErr: { formato: "Non sono riuscito a leggere quel file.", outro: "Quel file non è una copia di Clarim.", versao: "Quella copia viene da un Clarim più nuovo.", vazio: "Quella copia è vuota." },
    voiceOpens: "Clarim ti legge le domande. Si sono aperti dei giochi!",
    voice: "Voce di Clarim", voiceOn: "Attiva", voiceOff: "Spenta",
    ...
    momentInvite: "Un versetto breve ogni giorno, una domanda di cui parlare e un piccolo gesto — da fare insieme ai bambini, in pochi minuti. La vostra famiglia lo vuole in Clarim?",
    ...
    giftHint: "170 lumicoins a settimana da regalare a chi vuoi. Quel che avanza non si accumula.",
    weekTried: "partite finite senza stella. È arrivato in fondo lo stesso.",
    ...
    installTitle: "Tieni Clarim nella schermata Home",
