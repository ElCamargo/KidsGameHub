...
export const T = {
  pt: {
    ...
    askRegiao: "Em que região fica {p}?", whyRegiao: "{p} fica na região {r}.", whyMeuEstado: "Você mora em {p}, que fica na região {r}.",
    myState: "Onde eu moro", stateWhy: "Só para o jogo do Brasil começar pelo seu estado. Fica no aparelho.",
    ...
    backup: "Cópia de segurança", backupHint: "O progresso fica só neste aparelho. Salve uma cópia para não perder ao trocar de celular.",
    backupSave: "Salvar uma cópia", backupLoad: "Trazer uma cópia",
    backupAsk: "Trazer esta cópia apaga o que está neste aparelho agora — {n} perfil(is) entram no lugar. Continuar?",
    backupDone: "Pronto. O Lumus vai reabrir com a cópia.", backupBad: "Este arquivo não é uma cópia do Lumus.",
    backupOld: "Esta cópia é de uma versão mais nova do Lumus. Atualize o app antes de trazê-la.",
  },
  en: {
    ...
    askRegiao: "Which region is {p} in?", whyRegiao: "{p} is in the {r} region.", whyMeuEstado: "You live in {p}, which is in the {r} region.",
    myState: "Where I live", stateWhy: "Only so the Brazil game starts with your state. It stays on the device.",
    ...
    backup: "Backup", backupHint: "Progress lives on this device only. Save a copy so nothing is lost when you change phones.",
    backupSave: "Save a copy", backupLoad: "Load a copy",
    backupAsk: "Loading this copy erases what is on this device — {n} profile(s) take its place. Continue?",
    backupDone: "Done. Lumus will reopen with the copy.", backupBad: "This file is not a Lumus copy.",
    backupOld: "This copy comes from a newer Lumus. Update the app before loading it.",
  },
  es: {
    ...
    askRegiao: "¿En qué región está {p}?", whyRegiao: "{p} está en la región {r}.", whyMeuEstado: "Vives en {p}, que está en la región {r}.",
    myState: "Dónde vivo", stateWhy: "Solo para que el juego de Brasil empiece por tu estado. Se queda en el aparato.",
    ...
    backup: "Copia de seguridad", backupHint: "El progreso queda solo en este aparato. Guarda una copia para no perderlo al cambiar de teléfono.",
    backupSave: "Guardar una copia", backupLoad: "Traer una copia",
    backupAsk: "Traer esta copia borra lo que hay en este aparato — {n} perfil(es) ocupan su lugar. ¿Continuar?",
    backupDone: "Listo. Lumus va a reabrir con la copia.", backupBad: "Este archivo no es una copia de Lumus.",
    backupOld: "Esta copia es de una versión más nueva de Lumus. Actualiza la app antes de traerla.",
  },
};
...
export const PACKS = {
  fr: {
    ...
    askRegiao: "Dans quelle région se trouve {p} ?", whyRegiao: "{p} est dans la région {r}.", whyMeuEstado: "Tu habites {p}, qui est dans la région {r}.",
    myState: "Où j'habite", stateWhy: "Seulement pour que le jeu du Brésil commence par ton état. Ça reste sur l'appareil.",
    ...
    backup: "Sauvegarde", backupHint: "La progression reste sur cet appareil. Enregistre une copie pour ne rien perdre en changeant de téléphone.",
    backupSave: "Enregistrer une copie", backupLoad: "Charger une copie",
    backupAsk: "Charger cette copie efface ce qui est sur cet appareil — {n} profil(s) prennent la place. Continuer ?",
    backupDone: "C'est fait. Lumus va rouvrir avec la copie.", backupBad: "Ce fichier n'est pas une copie de Lumus.",
    backupOld: "Cette copie vient d'un Lumus plus récent. Mets l'application à jour avant de la charger.",
  },
  de: {
    ...
    askRegiao: "In welcher Region liegt {p}?", whyRegiao: "{p} liegt in der Region {r}.", whyMeuEstado: "Du wohnst in {p}, das in der Region {r} liegt.",
    myState: "Wo ich wohne", stateWhy: "Nur damit das Brasilien-Spiel bei deinem Bundesstaat beginnt. Bleibt auf dem Gerät.",
    ...
    backup: "Sicherungskopie", backupHint: "Der Fortschritt bleibt nur auf diesem Gerät. Speichere eine Kopie, damit beim Handywechsel nichts verloren geht.",
    backupSave: "Kopie speichern", backupLoad: "Kopie laden",
    backupAsk: "Diese Kopie zu laden löscht, was auf diesem Gerät ist — {n} Profil(e) treten an die Stelle. Fortfahren?",
    backupDone: "Fertig. Lumus startet mit der Kopie neu.", backupBad: "Diese Datei ist keine Lumus-Kopie.",
    backupOld: "Diese Kopie stammt aus einem neueren Lumus. Aktualisiere die App, bevor du sie lädst.",
  },
  it: {
    ...
    askRegiao: "In quale regione si trova {p}?", whyRegiao: "{p} si trova nella regione {r}.", whyMeuEstado: "Tu vivi in {p}, che si trova nella regione {r}.",
    myState: "Dove abito", stateWhy: "Solo perché il gioco del Brasile inizi dal tuo stato. Resta sul dispositivo.",
    ...
    backup: "Copia di sicurezza", backupHint: "I progressi restano solo su questo apparecchio. Salva una copia per non perderli cambiando telefono.",
    backupSave: "Salva una copia", backupLoad: "Carica una copia",
    backupAsk: "Caricare questa copia cancella quello che c'è su questo apparecchio — {n} profilo/i prendono il posto. Continuare?",
    backupDone: "Fatto. Lumus si riapre con la copia.", backupBad: "Questo file non è una copia di Lumus.",
    backupOld: "Questa copia viene da un Lumus più recente. Aggiorna l'app prima di caricarla.",
  },
};
